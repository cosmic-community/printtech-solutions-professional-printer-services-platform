export const metadata = {
  title: 'Contato - PrintTech Solutions',
  description: 'Entre em contato conosco para tirar dúvidas ou solicitar um orçamento',
}
        ...
        <div className="max-w-2xl mx-auto">
            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="compra">Compra de Equipamento</option>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">contato@printtech.com.br</p>
            </div>
